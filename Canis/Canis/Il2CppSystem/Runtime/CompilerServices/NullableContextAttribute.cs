...
namespace Il2CppSystem.Runtime.CompilerServices
{
	...
	{
		// Token: 0x0600000A RID: 10 RVA: 0x00019EFC File Offset: 0x000180FC
		// Note: this type is marked as 'beforefieldinit'.
		static NullableContextAttribute()
		{
			Il2CppClassPointerStore<NullableContextAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("Canis.dll", "System.Runtime.CompilerServices", "NullableContextAttribute");
		...
		// Token: 0x0600000B RID: 11 RVA: 0x00019F54 File Offset: 0x00018154
		[CallerCount(0)]
		...
		// (get) Token: 0x0600000D RID: 13 RVA: 0x00019F9C File Offset: 0x0001819C
