...
public class UnitySourceGeneratedAssemblyMonoScriptTypes_v1 : Object
{
	...
	{
		Il2CppClassPointerStore<global::UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("validators.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1267414, XrefRangeEnd = 1267427, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	{
		// Token: 0x060000FF RID: 255 RVA: 0x000057B0 File Offset: 0x000039B0
		// Note: this type is marked as 'beforefieldinit'.
		...
		// Token: 0x06000100 RID: 256 RVA: 0x00002764 File Offset: 0x00000964
		public MonoScriptData(IntPtr pointer)
			: base(pointer)
		{
		}

		// Token: 0x06000101 RID: 257 RVA: 0x0000276D File Offset: 0x0000096D
		...
		// (get) Token: 0x06000102 RID: 258 RVA: 0x00005840 File Offset: 0x00003A40
		// (set) Token: 0x06000103 RID: 259 RVA: 0x0000277F File Offset: 0x0000097F
		...
		// (get) Token: 0x06000104 RID: 260 RVA: 0x00005870 File Offset: 0x00003A70
		// (set) Token: 0x06000105 RID: 261 RVA: 0x0000279E File Offset: 0x0000099E
		...
		// (get) Token: 0x06000106 RID: 262 RVA: 0x000058A0 File Offset: 0x00003AA0
		// (set) Token: 0x06000107 RID: 263 RVA: 0x000027BD File Offset: 0x000009BD
		...
		// (get) Token: 0x06000108 RID: 264 RVA: 0x000058C8 File Offset: 0x00003AC8
		// (set) Token: 0x06000109 RID: 265 RVA: 0x000027D8 File Offset: 0x000009D8
		...
		// (get) Token: 0x0600010A RID: 266 RVA: 0x000058F0 File Offset: 0x00003AF0
		// (set) Token: 0x0600010B RID: 267 RVA: 0x000027F3 File Offset: 0x000009F3
