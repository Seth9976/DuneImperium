...
public class UnitySourceGeneratedAssemblyMonoScriptTypes_v1 : Object
{
	...
	{
		Il2CppClassPointerStore<global::UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("DwdJson.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1247814, XrefRangeEnd = 1247827, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	{
		// Token: 0x0600010A RID: 266 RVA: 0x00006474 File Offset: 0x00004674
		// Note: this type is marked as 'beforefieldinit'.
		...
		// Token: 0x0600010B RID: 267 RVA: 0x00002664 File Offset: 0x00000864
		public MonoScriptData(IntPtr pointer)
			: base(pointer)
		{
		}

		// Token: 0x0600010C RID: 268 RVA: 0x0000266D File Offset: 0x0000086D
		...
		// (get) Token: 0x0600010D RID: 269 RVA: 0x00006504 File Offset: 0x00004704
		// (set) Token: 0x0600010E RID: 270 RVA: 0x0000267F File Offset: 0x0000087F
		...
		// (get) Token: 0x0600010F RID: 271 RVA: 0x00006534 File Offset: 0x00004734
		// (set) Token: 0x06000110 RID: 272 RVA: 0x0000269E File Offset: 0x0000089E
		...
		// (get) Token: 0x06000111 RID: 273 RVA: 0x00006564 File Offset: 0x00004764
		// (set) Token: 0x06000112 RID: 274 RVA: 0x000026BD File Offset: 0x000008BD
		...
		// (get) Token: 0x06000113 RID: 275 RVA: 0x0000658C File Offset: 0x0000478C
		// (set) Token: 0x06000114 RID: 276 RVA: 0x000026D8 File Offset: 0x000008D8
		...
		// (get) Token: 0x06000115 RID: 277 RVA: 0x000065B4 File Offset: 0x000047B4
		// (set) Token: 0x06000116 RID: 278 RVA: 0x000026F3 File Offset: 0x000008F3
