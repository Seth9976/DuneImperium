...
{
	// Token: 0x06000026 RID: 38 RVA: 0x000032A0 File Offset: 0x000014A0
	// Note: this type is marked as 'beforefieldinit'.
	static UnitySourceGeneratedAssemblyMonoScriptTypes_v1()
	{
		Il2CppClassPointerStore<UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("WebSocket.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr);
		UnitySourceGeneratedAssemblyMonoScriptTypes_v1.NativeMethodInfoPtr_Get_Private_Static_MonoScriptData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr, 100663330);
		UnitySourceGeneratedAssemblyMonoScriptTypes_v1.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr, 100663331);
	}

	// Token: 0x06000027 RID: 39 RVA: 0x000032F8 File Offset: 0x000014F8
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1262459, XrefRangeEnd = 1262472, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	// Token: 0x06000028 RID: 40 RVA: 0x00003324 File Offset: 0x00001524
	[CallerCount(2676)]
	...
	{
		// Token: 0x06000088 RID: 136 RVA: 0x000045BC File Offset: 0x000027BC
		// Note: this type is marked as 'beforefieldinit'.
		...
		// Token: 0x06000089 RID: 137 RVA: 0x00002414 File Offset: 0x00000614
		...
		// (get) Token: 0x0600008B RID: 139 RVA: 0x0000464C File Offset: 0x0000284C
		// (set) Token: 0x0600008C RID: 140 RVA: 0x0000242F File Offset: 0x0000062F
		...
		// (get) Token: 0x0600008D RID: 141 RVA: 0x0000467C File Offset: 0x0000287C
		// (set) Token: 0x0600008E RID: 142 RVA: 0x0000244E File Offset: 0x0000064E
		...
		// (get) Token: 0x0600008F RID: 143 RVA: 0x000046AC File Offset: 0x000028AC
		// (set) Token: 0x06000090 RID: 144 RVA: 0x0000246D File Offset: 0x0000066D
		...
		// (get) Token: 0x06000091 RID: 145 RVA: 0x000046D4 File Offset: 0x000028D4
		// (set) Token: 0x06000092 RID: 146 RVA: 0x00002488 File Offset: 0x00000688
		...
		// (get) Token: 0x06000093 RID: 147 RVA: 0x000046FC File Offset: 0x000028FC
		// (set) Token: 0x06000094 RID: 148 RVA: 0x000024A3 File Offset: 0x000006A3
