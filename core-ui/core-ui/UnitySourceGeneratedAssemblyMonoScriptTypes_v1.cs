...
{
	// Token: 0x0600000F RID: 15 RVA: 0x00002DF8 File Offset: 0x00000FF8
	// Note: this type is marked as 'beforefieldinit'.
	static UnitySourceGeneratedAssemblyMonoScriptTypes_v1()
	{
		Il2CppClassPointerStore<global::UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("core-ui.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1253387, XrefRangeEnd = 1253400, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	// Token: 0x06000011 RID: 17 RVA: 0x00002E7C File Offset: 0x0000107C
	[CallerCount(2676)]
	...
	{
		// Token: 0x06000136 RID: 310 RVA: 0x00006A20 File Offset: 0x00004C20
		// Note: this type is marked as 'beforefieldinit'.
		...
		// Token: 0x06000137 RID: 311 RVA: 0x000028C7 File Offset: 0x00000AC7
		public MonoScriptData(IntPtr pointer)
			: base(pointer)
		{
		}

		// Token: 0x06000138 RID: 312 RVA: 0x000028D0 File Offset: 0x00000AD0
		...
		// (get) Token: 0x06000139 RID: 313 RVA: 0x00006AB0 File Offset: 0x00004CB0
		// (set) Token: 0x0600013A RID: 314 RVA: 0x000028E2 File Offset: 0x00000AE2
		...
		// (get) Token: 0x0600013B RID: 315 RVA: 0x00006AE0 File Offset: 0x00004CE0
		// (set) Token: 0x0600013C RID: 316 RVA: 0x00002901 File Offset: 0x00000B01
		...
		// (get) Token: 0x0600013D RID: 317 RVA: 0x00006B10 File Offset: 0x00004D10
		// (set) Token: 0x0600013E RID: 318 RVA: 0x00002920 File Offset: 0x00000B20
		...
		// (get) Token: 0x0600013F RID: 319 RVA: 0x00006B38 File Offset: 0x00004D38
		// (set) Token: 0x06000140 RID: 320 RVA: 0x0000293B File Offset: 0x00000B3B
		...
		// (get) Token: 0x06000141 RID: 321 RVA: 0x00006B60 File Offset: 0x00004D60
		// (set) Token: 0x06000142 RID: 322 RVA: 0x00002956 File Offset: 0x00000B56
