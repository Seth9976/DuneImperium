...
public class UnitySourceGeneratedAssemblyMonoScriptTypes_v1 : Object
{
	...
	{
		Il2CppClassPointerStore<global::UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("console.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
	...
	// Token: 0x06000010 RID: 16 RVA: 0x00002F14 File Offset: 0x00001114
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1255282, XrefRangeEnd = 1255295, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public sealed class MonoScriptData : ValueType
	{
		...
		// Token: 0x0600011C RID: 284 RVA: 0x00002A39 File Offset: 0x00000C39
		public MonoScriptData(IntPtr pointer)
			: base(pointer)
		{
		}

		// Token: 0x0600011D RID: 285 RVA: 0x00002A42 File Offset: 0x00000C42
		...
		// (get) Token: 0x0600011E RID: 286 RVA: 0x00005DF4 File Offset: 0x00003FF4
		// (set) Token: 0x0600011F RID: 287 RVA: 0x00002A54 File Offset: 0x00000C54
		...
		// (get) Token: 0x06000120 RID: 288 RVA: 0x00005E24 File Offset: 0x00004024
		// (set) Token: 0x06000121 RID: 289 RVA: 0x00002A73 File Offset: 0x00000C73
		...
		// (get) Token: 0x06000122 RID: 290 RVA: 0x00005E54 File Offset: 0x00004054
		// (set) Token: 0x06000123 RID: 291 RVA: 0x00002A92 File Offset: 0x00000C92
		...
		// (get) Token: 0x06000124 RID: 292 RVA: 0x00005E7C File Offset: 0x0000407C
		// (set) Token: 0x06000125 RID: 293 RVA: 0x00002AAD File Offset: 0x00000CAD
		...
		// (get) Token: 0x06000126 RID: 294 RVA: 0x00005EA4 File Offset: 0x000040A4
		// (set) Token: 0x06000127 RID: 295 RVA: 0x00002AC8 File Offset: 0x00000CC8
