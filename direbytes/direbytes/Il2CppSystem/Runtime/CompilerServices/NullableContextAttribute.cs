...
namespace Il2CppSystem.Runtime.CompilerServices
{
	...
	{
		// Token: 0x0600000A RID: 10 RVA: 0x000038DC File Offset: 0x00001ADC
		// Note: this type is marked as 'beforefieldinit'.
		static NullableContextAttribute()
		{
			Il2CppClassPointerStore<NullableContextAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("direbytes.dll", "System.Runtime.CompilerServices", "NullableContextAttribute");
		...
		// Token: 0x0600000B RID: 11 RVA: 0x00003934 File Offset: 0x00001B34
		[CallerCount(0)]
		...
		// (get) Token: 0x0600000D RID: 13 RVA: 0x0000397C File Offset: 0x00001B7C
