...
namespace Il2CppMicrosoft.CodeAnalysis
{
	...
	public sealed class EmbeddedAttribute : Attribute
	{
		...
		{
			Il2CppClassPointerStore<EmbeddedAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("worm-canis.dll", "Microsoft.CodeAnalysis", "EmbeddedAttribute");
		...
		// Token: 0x06000002 RID: 2 RVA: 0x00068E00 File Offset: 0x00067000
		[CallerCount(220)]
		[CachedScanResults(RefRangeStart = 1, RefRangeEnd = 221, XrefRangeStart = 0, XrefRangeEnd = 1, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
