...
namespace Il2CppMicrosoft.CodeAnalysis
{
	...
	public sealed class EmbeddedAttribute : Attribute
	{
		...
		{
			Il2CppClassPointerStore<EmbeddedAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.RenderPipelines.Core.Runtime.dll", "Microsoft.CodeAnalysis", "EmbeddedAttribute");
		...
		// Token: 0x06000002 RID: 2 RVA: 0x0000E2EC File Offset: 0x0000C4EC
		[CallerCount(220)]
