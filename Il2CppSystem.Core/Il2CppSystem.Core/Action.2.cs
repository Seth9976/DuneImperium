...
namespace Il2CppSystem
{
	...
	public sealed class Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : MulticastDelegate
	{
		// Token: 0x0600000D RID: 13 RVA: 0x0000B784 File Offset: 0x00009984
		// Note: this type is marked as 'beforefieldinit'.
		static Action()
		{
			Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.NativeClassPtr = IL2CPP.il2cpp_class_from_type(Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(IL2CPP.GetIl2CppClass("System.Core.dll", "System", "Action`10"))).MakeGenericType(new Il2CppReferenceArray<Type>(new Type[]
			{
			...
			Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.NativeClassPtr, 100663304);
			Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_T1_T2_T3_T4_T5_T6_T7_T8_T9_T10_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.NativeClassPtr, 100663305);
		}

		// Token: 0x0600000E RID: 14 RVA: 0x0000B8B4 File Offset: 0x00009AB4
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1002084, XrefRangeEnd = 1002093, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe Action(Object @object, IntPtr method)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.NativeClassPtr))
		{
			IntPtr* ptr;
			checked
			{
			...
			IntPtr intPtr2;
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		// Token: 0x0600000F RID: 15 RVA: 0x0000B910 File Offset: 0x00009B10
		[CallerCount(0)]
		public unsafe void Invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8, T9 arg9, T10 arg10)
		{
			...
			ptr11 = intPtr10;
			IntPtr intPtr12;
			IntPtr intPtr11 = IL2CPP.il2cpp_runtime_invoke(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_T1_T2_T3_T4_T5_T6_T7_T8_T9_T10_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)ptr, ref intPtr12);
			Il2CppException.RaiseExceptionIfNecessary(intPtr12);
		}

		// Token: 0x06000010 RID: 16 RVA: 0x00002070 File Offset: 0x00000270
		...
		private static readonly IntPtr NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_T1_T2_T3_T4_T5_T6_T7_T8_T9_T10_0;
	}
}
