...
namespace Il2CppSystem
{
	...
	public sealed class Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : MulticastDelegate
	{
		// Token: 0x06000029 RID: 41 RVA: 0x0000DF3C File Offset: 0x0000C13C
		// Note: this type is marked as 'beforefieldinit'.
		static Func()
		{
			Il2CppClassPointerStore<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>>.NativeClassPtr = IL2CPP.il2cpp_class_from_type(Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(IL2CPP.GetIl2CppClass("System.Core.dll", "System", "Func`10"))).MakeGenericType(new Il2CppReferenceArray<Type>(new Type[]
			{
			...
			Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>>.NativeClassPtr, 100663318);
			Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>.NativeMethodInfoPtr_Invoke_Public_Virtual_New_TResult_T1_T2_T3_T4_T5_T6_T7_T8_T9_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>>.NativeClassPtr, 100663319);
		}

		// Token: 0x0600002A RID: 42 RVA: 0x0000E06C File Offset: 0x0000C26C
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1002147, XrefRangeEnd = 1002156, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe Func(Object @object, IntPtr method)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>>.NativeClassPtr))
		{
			IntPtr* ptr;
			checked
			{
			...
			IntPtr intPtr2;
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		// Token: 0x0600002B RID: 43 RVA: 0x0000E0C8 File Offset: 0x0000C2C8
		[CallerCount(0)]
		public unsafe TResult Invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8, T9 arg9)
		{
			...
			ptr10 = intPtr9;
			IntPtr intPtr11;
			IntPtr intPtr10 = IL2CPP.il2cpp_runtime_invoke(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>.NativeMethodInfoPtr_Invoke_Public_Virtual_New_TResult_T1_T2_T3_T4_T5_T6_T7_T8_T9_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)ptr, ref intPtr11);
			Il2CppException.RaiseExceptionIfNecessary(intPtr11);
			return IL2CPP.PointerToValueGeneric<TResult>(intPtr10, false, true);
		}

		// Token: 0x0600002C RID: 44 RVA: 0x000020AF File Offset: 0x000002AF
		...
		private static readonly IntPtr NativeMethodInfoPtr_Invoke_Public_Virtual_New_TResult_T1_T2_T3_T4_T5_T6_T7_T8_T9_0;
	}
}
