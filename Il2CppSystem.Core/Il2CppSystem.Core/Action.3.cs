...
namespace Il2CppSystem
{
	...
	public sealed class Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : MulticastDelegate
	{
		// Token: 0x06000011 RID: 17 RVA: 0x0000BC1C File Offset: 0x00009E1C
		// Note: this type is marked as 'beforefieldinit'.
		static Action()
		{
			Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.NativeClassPtr = IL2CPP.il2cpp_class_from_type(Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(IL2CPP.GetIl2CppClass("System.Core.dll", "System", "Action`11"))).MakeGenericType(new Il2CppReferenceArray<Type>(new Type[]
			{
			...
			Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.NativeClassPtr, 100663306);
			Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_T1_T2_T3_T4_T5_T6_T7_T8_T9_T10_T11_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.NativeClassPtr, 100663307);
		}

		// Token: 0x06000012 RID: 18 RVA: 0x0000BD5C File Offset: 0x00009F5C
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1002093, XrefRangeEnd = 1002102, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe Action(Object @object, IntPtr method)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.NativeClassPtr))
		{
			IntPtr* ptr;
			checked
			{
			...
			IntPtr intPtr2;
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		// Token: 0x06000013 RID: 19 RVA: 0x0000BDB8 File Offset: 0x00009FB8
		[CallerCount(0)]
		public unsafe void Invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8, T9 arg9, T10 arg10, T11 arg11)
		{
			...
			ptr12 = intPtr11;
			IntPtr intPtr13;
			IntPtr intPtr12 = IL2CPP.il2cpp_runtime_invoke(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_T1_T2_T3_T4_T5_T6_T7_T8_T9_T10_T11_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)ptr, ref intPtr13);
			Il2CppException.RaiseExceptionIfNecessary(intPtr13);
		}

		// Token: 0x06000014 RID: 20 RVA: 0x00002079 File Offset: 0x00000279
		...
		private static readonly IntPtr NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_T1_T2_T3_T4_T5_T6_T7_T8_T9_T10_T11_0;
	}
}
