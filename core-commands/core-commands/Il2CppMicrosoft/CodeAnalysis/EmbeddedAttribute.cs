...
namespace Il2CppMicrosoft.CodeAnalysis
{
	...
	public sealed class EmbeddedAttribute : Attribute
	{
		...
		{
			Il2CppClassPointerStore<EmbeddedAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("core-commands.dll", "Microsoft.CodeAnalysis", "EmbeddedAttribute");
		...
		// Token: 0x06000002 RID: 2 RVA: 0x0000495C File Offset: 0x00002B5C
		[CallerCount(220)]
