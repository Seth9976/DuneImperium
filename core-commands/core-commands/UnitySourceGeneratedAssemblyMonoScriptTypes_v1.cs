...
{
	// Token: 0x0600000F RID: 15 RVA: 0x00004B90 File Offset: 0x00002D90
	// Note: this type is marked as 'beforefieldinit'.
	static UnitySourceGeneratedAssemblyMonoScriptTypes_v1()
	{
		Il2CppClassPointerStore<global::UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("core-commands.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
	...
	// Token: 0x06000010 RID: 16 RVA: 0x00004BE8 File Offset: 0x00002DE8
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1205731, XrefRangeEnd = 1205744, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	// Token: 0x06000011 RID: 17 RVA: 0x00004C14 File Offset: 0x00002E14
	[CallerCount(2676)]
	...
	{
		// Token: 0x06000213 RID: 531 RVA: 0x0000CC80 File Offset: 0x0000AE80
		// Note: this type is marked as 'beforefieldinit'.
		...
		// Token: 0x06000214 RID: 532 RVA: 0x00002DE1 File Offset: 0x00000FE1
		public MonoScriptData(IntPtr pointer)
			: base(pointer)
		{
		}

		// Token: 0x06000215 RID: 533 RVA: 0x00002DEA File Offset: 0x00000FEA
		...
		// (get) Token: 0x06000216 RID: 534 RVA: 0x0000CD10 File Offset: 0x0000AF10
		// (set) Token: 0x06000217 RID: 535 RVA: 0x00002DFC File Offset: 0x00000FFC
		...
		// (get) Token: 0x06000218 RID: 536 RVA: 0x0000CD40 File Offset: 0x0000AF40
		// (set) Token: 0x06000219 RID: 537 RVA: 0x00002E1B File Offset: 0x0000101B
		...
		// (get) Token: 0x0600021A RID: 538 RVA: 0x0000CD70 File Offset: 0x0000AF70
		// (set) Token: 0x0600021B RID: 539 RVA: 0x00002E3A File Offset: 0x0000103A
		...
		// (get) Token: 0x0600021C RID: 540 RVA: 0x0000CD98 File Offset: 0x0000AF98
		// (set) Token: 0x0600021D RID: 541 RVA: 0x00002E55 File Offset: 0x00001055
		...
		// (get) Token: 0x0600021E RID: 542 RVA: 0x0000CDC0 File Offset: 0x0000AFC0
		// (set) Token: 0x0600021F RID: 543 RVA: 0x00002E70 File Offset: 0x00001070
