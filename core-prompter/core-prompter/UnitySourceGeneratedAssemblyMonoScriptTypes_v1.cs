...
{
	// Token: 0x0600000F RID: 15 RVA: 0x0000422C File Offset: 0x0000242C
	// Note: this type is marked as 'beforefieldinit'.
	static UnitySourceGeneratedAssemblyMonoScriptTypes_v1()
	{
		Il2CppClassPointerStore<global::UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("core-prompter.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
	...
	// Token: 0x06000010 RID: 16 RVA: 0x00004284 File Offset: 0x00002484
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 1212903, XrefRangeEnd = 1212916, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	// Token: 0x06000011 RID: 17 RVA: 0x000042B0 File Offset: 0x000024B0
	[CallerCount(2676)]
	...
	{
		// Token: 0x06000292 RID: 658 RVA: 0x0000C35C File Offset: 0x0000A55C
		// Note: this type is marked as 'beforefieldinit'.
		...
		// Token: 0x06000293 RID: 659 RVA: 0x0000348C File Offset: 0x0000168C
		public MonoScriptData(IntPtr pointer)
			: base(pointer)
		{
		}

		// Token: 0x06000294 RID: 660 RVA: 0x00003495 File Offset: 0x00001695
		...
		// (get) Token: 0x06000295 RID: 661 RVA: 0x0000C3EC File Offset: 0x0000A5EC
		// (set) Token: 0x06000296 RID: 662 RVA: 0x000034A7 File Offset: 0x000016A7
		...
		// (get) Token: 0x06000297 RID: 663 RVA: 0x0000C41C File Offset: 0x0000A61C
		// (set) Token: 0x06000298 RID: 664 RVA: 0x000034C6 File Offset: 0x000016C6
		...
		// (get) Token: 0x06000299 RID: 665 RVA: 0x0000C44C File Offset: 0x0000A64C
		// (set) Token: 0x0600029A RID: 666 RVA: 0x000034E5 File Offset: 0x000016E5
		...
		// (get) Token: 0x0600029B RID: 667 RVA: 0x0000C474 File Offset: 0x0000A674
		// (set) Token: 0x0600029C RID: 668 RVA: 0x00003500 File Offset: 0x00001700
		...
		// (get) Token: 0x0600029D RID: 669 RVA: 0x0000C49C File Offset: 0x0000A69C
		// (set) Token: 0x0600029E RID: 670 RVA: 0x0000351B File Offset: 0x0000171B
