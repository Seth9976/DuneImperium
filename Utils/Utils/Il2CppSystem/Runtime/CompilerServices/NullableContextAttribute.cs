...
namespace Il2CppSystem.Runtime.CompilerServices
{
	...
	{
		// Token: 0x0600000A RID: 10 RVA: 0x00004720 File Offset: 0x00002920
		// Note: this type is marked as 'beforefieldinit'.
		static NullableContextAttribute()
		{
			Il2CppClassPointerStore<NullableContextAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("Utils.dll", "System.Runtime.CompilerServices", "NullableContextAttribute");
		...
		// Token: 0x0600000B RID: 11 RVA: 0x00004778 File Offset: 0x00002978
		[CallerCount(0)]
		...
		// (get) Token: 0x0600000D RID: 13 RVA: 0x000047C0 File Offset: 0x000029C0
